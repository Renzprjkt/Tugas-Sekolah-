	...
	<div id="content-wrap"><div id="content">	 
		...
		<a href="<?php echo $br[3]?>" class="a2" target="commerce"><strong><?php echo $br[1]?></strong></a><?php }?>
				...
				<div class="sidebox">
					...
					<BR>
					<a href="mailto:eddyyuliansyah@yahoo.com">Alip Putra (01)</a>
					<BR>
					<a href="mailto:stevenmamet@rocketmail.com/">Muhammad Nurhalim(17)</a>
					<BR>
					<a href="mailto:liadwikurnia@yahoo.com/">Shendy Reynaldi (20)</a>
					</p>
				</div>	
		...
		<div id="main">		
			...
			<div class="box">
				...
				<!-- <code> -->
				<CENTER><iframe name="commerce" width="600" height="500" background="#1E89DCs" src="utama.gif"></iframe></CENTER>
				<!-- </code>	 -->
